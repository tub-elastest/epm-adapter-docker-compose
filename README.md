...
[![Build Status](https://ci.elastest.io/jenkins/buildStatus/icon?job=elastest-platform-manager/epm-adapter-docker-compose)](https://ci.elastest.io/jenkins/job/elastest-platform-manager/job/epm-adapter-docker-compose)
[![Quality Gate](https://sonarcloud.io/api/badges/gate?key=io.elastest:epm-adapter-docker-compose)](https://sonarcloud.io/dashboard/index/io.elastest:epm-adapter-docker-compose)
[![codecov](https://codecov.io/gh/elastest/elastest-platform-manager-adapter-docker-compose/branch/master/graph/badge.svg)](https://codecov.io/gh/elastest/elastest-platform-manager-adapter-docker-compose)
...
This repository contains an adapter to be used by the ElasTest Platform Manager to support docker-compose as a virtualization technology. Further documentation can be found [here](https://github.com/tub-elastest/epm-adapter-docker-compose/blob/master/docs/index.md).

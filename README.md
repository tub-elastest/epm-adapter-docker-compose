...
This repository contains an adapter to be used by the ElasTest Platform Manager to support docker-compose as a virtualization technology. Further documentation can be found [here](https://github.com/mpauls/epm-adapter-docker-compose/blob/master/docs/index.md).
